...
///////////////////////////////////////////////////////////////////////////////
// Name: main()
// Desc: Точка входа для приложения. Мы используем только консольное окно
///////////////////////////////////////////////////////////////////////////////
int __cdecl main(int argc, char* argv[])
{
    ...
    else
    {
        ...
        // если нам нужны касательные или бинормали, сгенерировать их
...
//--------------------------------------------------------------------------------------
// Анализирует командную строку на наличие параметров. См. DXUTInit() для списка 
//--------------------------------------------------------------------------------------
bool ParseCommandLine( SETTINGS* pSettings )
{
    ...
    for( int iArg=1; iArg<nNumArgs; iArg++ )
    {
        ...
        // Обработка аргументов фгагов (args)
        ...
        {
            // Обрабатывать аргументы без флага как отдельный входной файл
