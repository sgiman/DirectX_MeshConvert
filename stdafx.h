...
#pragma warning( disable : 4100 ) // отключить предупреждени€ формальных параметров без ссылок дл€ сборок /W 4
...
//--------------------------------------------------------------------------------------
// ѕростой вспомогательный класс стека
//--------------------------------------------------------------------------------------
template <class T>
class CStack
{
